...
class Game {
  constructor(canvas, currentOpponent) {
    ...
    switch (currentOpponent) {
      case "glassJoe":
        this.loadSprites("opponent", "assets/img/glass_nemz.png");
        break;
      case "vonKaiser":
    ...
    this.loadSprites("mac", "assets/img/little_blu.png");
    this.loadSprites("joe", "assets/img/glass_nemz.png");
  ...
  intro() {
    ...
    this.data.canvas.ctxTop.fillText("#1 Twitch Circuit: Nemz38",150,120);
